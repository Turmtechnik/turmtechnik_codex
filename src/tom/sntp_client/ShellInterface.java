package com.awr_technology.sntp_client;
    ...
    private static String _runCommand(String command, OUTPUT o) throws IOException {
        ...
        try {
            try {
                ...
                // Unter Android 10/11 oft "Permission denied" (errno 13) – kein root/su
                Log.w(TAG, "exec(" + shell + ") fehlgeschlagen (z. B. Permission denied): " + e.getMessage());
                throw e;
            }
