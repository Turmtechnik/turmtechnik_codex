...
import com.awr_technology.marine.nmea.sentence.XTESentence;
import com.awr_technology.marine.nmea.util.DataStatus;
import com.awr_technology.marine.nmea.util.Direction;
...
class XTEParser extends SentenceParser implements XTESentence {
     ...
     *
     *
     * f.marineapi.nmea.sentence.XTESentence#getCycleLockStatus()
     */
    @Override
